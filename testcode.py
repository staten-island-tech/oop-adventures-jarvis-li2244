    ...
    def map():
        ...
        while True:
            ...
            for i in range(spawn_amount):
                enemy_pos = Map[Maper.spawn_positions()[0]][Maper.spawn_positions()[1]]
                counter.append(enemy_pos)
                Map[Maper.spawn_positions()[0]][Maper.spawn_positions()[1]] = '[O]'
                if len(counter) > spawn_amount:
                    pass
